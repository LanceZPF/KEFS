...
for epoch in range(start_epoch, opt.nepoch):
    ...
    # train GAN
    real_atts, embedding_gcnv = trainFGGAN(epoch, features, labels)
    # synthesize features

    # unseen_attributes = real_atts[unseen_classes_ids]

    syn_feature, syn_label = trainFGGAN.generate_syn_feature(unseen_att_labels, unseen_attributes, embedding_gcnv, num=opt.syn_num)
