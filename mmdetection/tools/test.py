...
from mmcv.runner import get_dist_info, load_checkpoint, load_state_dict
...
def parse_args():
    ...
    parser.add_argument('--config', default='/data5/zpf/RRFS-main-new/mmdetection/configs/pascal_voc/faster_rcnn_r101_fpn_1x_voc0712.py', help='test config file path')
    parser.add_argument('--checkpoint', default = '/data5/zpf/RRFS-main-new/mmdetection/work_dirs/voc0712/epoch_4.pth', help='checkpoint file')
    parser.add_argument('--syn_weights', default = '/data5/zpf/RRFS-main-new/checkpoints/VOC_g1g2g3/classifier_best.pth', help='the dir to save logs and models')

    parser.add_argument('--out', default='voc_results.pkl', help='output result file')
    ...
    parser.add_argument('--dataset', default='voc', help='coco, voc, imagenet')
    parser.add_argument(
        '--json_out',
