...
def parse_args():
    ...
    parser.add_argument('--load_from', default='/data5/zpf/RRFS-main-new/mmdetection/work_dirs/voc0712/epoch_4.pth', help='the checkpoint file to load from')
    parser.add_argument('--save_dir', default='/data5/zpf/RRFS-main-new/data/voc', help='the dir to save feats and labels')
...
def extract_feats(model, datasets, cfg, save_dir, data_split='train', logger=None):
    #np.save(f'{save_dir}/1111_feats.npy', np.array([1]))
