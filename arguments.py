...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='./data/voc', help='path to dataset')
    ...
    parser.add_argument('--pretrain_classifier', default='/data5/zpf/RRFS-main-new/mmdetection/work_dirs/faster_rcnn_r101_gcn/epoch_4.pth', help="path to pretrain classifier (for seen classes loss on fake features)")
    parser.add_argument('--pretrain_classifier_unseen', default=None, help="path to pretrain classifier (for unseen classes loss on fake features)")
    ...
    # parser.add_argument('--netG', default='/data5/zpf/RRFS-main-new/checkpoints/VOC/gen_latest.pth', help="path to netG (to continue training)")
    # parser.add_argument('--netD', default='/data5/zpf/RRFS-main-new/checkpoints/VOC/disc_latest.pth', help="path to netD (to continue training)")
    ...
    parser.add_argument('--adj_file1', default='/data5/zpf/RRFS-main-new/mmdetection/adj/voc_adj.pkl')
    parser.add_argument('--adj_file2', default='/data5/zpf/RRFS-main-new/mmdetection/adj/voc_hyp_adj.pkl')
    parser.add_argument('--adj_file3', default='/data5/zpf/RRFS-main-new/mmdetection/adj/voc_out_adj.pkl')
    parser.add_argument('--inp_name', default='/data5/zpf/RRFS-main-new/VOC/fasttext_synonym.npy')
    ...
    parser.add_argument('--n_embed', default=10, type=int)  # num of part segment
    ...
    parser.add_argument('--dmodel_channels', default=256, type=int)
    parser.add_argument('--dout_channels', default=1, type=int)

    parser.add_argument('--linear_start', default=8.5e-4, type=float)
    parser.add_argument('--linear_end', default=1.2e-2, type=float)
